...
export const GARDLE_TOKEN_NAME = 'ga_tk';

export const IMAGE_COMPRESSION_QUALITY = 0.8;
export const IMAGE_COMPRESSION_MAXSIZE = 2048;

export const IMAGE_BASE_URL = 'https://s3.eu-central-1.amazonaws.com/images.gardle.ga';
