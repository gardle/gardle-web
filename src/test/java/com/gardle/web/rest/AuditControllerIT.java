...
import com.gardle.config.audit.AuditEventConverter;
import com.gardle.domain.PersistentAuditEvent;
import com.gardle.repository.PersistenceAuditEventRepository;
import com.gardle.service.AuditEventService;
...
public class AuditControllerIT {
    ...
    @Test
    @Transactional
    public void testPersistentAuditEventEquals() {
